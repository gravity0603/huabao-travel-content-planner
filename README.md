...
详细工作流见 [SKILL.md](SKILL.md)，数据契约见 [references/data-contract.md](references/data-contract.md)，策略证据见 [references/evidence-index.md](references/evidence-index.md)。
